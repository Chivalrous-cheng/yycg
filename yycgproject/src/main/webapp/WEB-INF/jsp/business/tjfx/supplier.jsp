...
<script type="text/javascript">
	...
	$(function() {
		$('#supplierlist').datagrid({
			...
			striped : true,//条纹显示效果
			url : '${baseurl}tjfx/statisticsByGys_result.action',//加载数据的连接，引连接请求过来是json数据
	...
	function querypurchaseorders(){
		...
		var formdata = $("#supplierqueryForm").serializeJson();
		$('#supplierlist').datagrid('load',formdata);
	}
