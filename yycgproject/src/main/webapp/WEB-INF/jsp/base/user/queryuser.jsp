	...
	<TABLE class="table_search">
		<TBODY>
			<TR>
				...
				<td><INPUT type="text" name="sysusercoustomer.userid" /></TD>
				<TD class="left">用户名称：</TD>
				<td><INPUT type="text" name="sysusercoustomer.username" /></TD>

				<TD class="left">单位名称：</TD>
				<td><INPUT type="text" name="sysusercoustomer.mc" /></TD>
				<TD class="left">用户类型：</TD>
				<td><select name="sysusercoustomer.groupid">
